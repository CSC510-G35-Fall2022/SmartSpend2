...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|----------|
| Video 1 Very important: A 5min video of new functionality, showing a significant delta from old.| 3 | main readme under videos|
|Bonus X-Fold improvement: In some aspect of the code; theoretical complexity, runtime, memory, developer time...|      3       | see scalability section in main readme for a design showing scalability|
| Docs: what: point descriptions of each class/function (in isolation)                                                                                                                    |        3         | [docs](https://github.com/CSC510-G35-Fall2022/SmartSpend2/blob/main/docs/functionDescription.md)|
| Use of style checkers                                                                                                                                                                   |         3      |see under Run style check in [INSTALL.md](https://github.com/CSC510-G35-Fall2022/SmartSpend2/blob/main/INSTALL.md)|
| Use of version control tools                                                                                                                                                            |         3        |git hub is a version control tool. |
| Use of code formatters.                                                                                                                                                                 |          3       |see under Run style check in [INSTALL.md](https://github.com/CSC510-G35-Fall2022/SmartSpend2/blob/main/INSTALL.md)|
| Use of code coverage                                                                                                                                                                    |         3        | see code coverage badge in main readme |
| Other automated analysis tools                                                                                                                                                          |         3        |see under Run style check in [INSTALL.md](https://github.com/CSC510-G35-Fall2022/SmartSpend2/blob/main/INSTALL.md)|
| Workload is spread over the whole team (one team member is often Xtimes more productive than the others...but nevertheless, here is a track record that everyone is contributing a lot) |        3         |contributors tab|
| Number of commits                                                                                                                                                                       |         3        |contributors tab|
| Number of commits: by different people                                                                                                                                                  |         3        |contributors tab|
| Issues reports: there are many                                                                                                                                                          |         3        |issues tab|
| Issues are being closed                                                                                                                                                                 |         3        |issues tab|
| DOI badge: exists                                                                                                                                                                       |        3         |doi badge in main readme|
| Docs: doco generated, format not ugly                                                                                                                                                   |        3         |see docs folder|
| Docs: what: point descriptions of each class/function (in isolation)                                                                                                                    |        3         | main readme, docs folder|
| Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z                                                                                         |         3        | main readme under mini tutorials|
| Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing                                                           |          3       |see main readme at the top|
| Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.                                                                             |          3       |see videos under main readme|
| Use of version control tools                                                                                                                                                            |         3        |github|
| Test cases exist                                                                                                                                                                        |         3        |automated and blackbox tests in test folder|
| Test cases are routinely executed                                                                                                                                                       |         3        |see github actions|
| The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up                                                                |         3        | see contributing.md|
| Issues are discussed before they are closed                                                                                                                                             |         3        |issues tab or in Discord Chat|
...
| Test cases: a large proportion of the issues related to handling failing cases.                                                                                                         |        2         |see issues tab|
| Evidence that the whole team is using the same tools: everyone can get to all tools and files                                                                                           |        3         |can prove when asked. also everyone has been contributing|
| Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)                                                               |       3          |see requirements.txt|
...
| Evidence that the members of the team are working across multiple places in the code base                                                                                               |         3        |see contributors|
| Short release cycles                                                                                                                                                                    |        3         |see release cycles|
| Does the website and documentation provide a clear, high-level overview of the software?                                                                                                                       |  3     | Yes
| Does the website and documentation clearly describe the type of user who should use the software?                                                                                                              |  3     | see docs
| Did the team publish case studies to show how the software has been used by team and others?                                                                                                                   |  2     | In README.md
| Is the name of the project/software unique?                                                                                                                                                                    |   3    | Yes SmartSpend is unique
| Is the project/software name free from trademark violations?                                                                                                                                                   |   3    | Yes
| Is the software available as a package that can be deployed without building it?                                                                                                                               |   0    | No, must run python code/code.py locally
...
| Is the documentation clearly available on your website or within your software?                                                                                                                                |   3    | docs folder
| Does the documentation include a "quick start" guide, that provides a short overview of how to use the software with some basic examples of use?                                                               |   3    | docs folder, main readme
| If team has provided more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use the software?                                                                   |   3    | install.md
| Did the team provide a comprehensive guide to all the software’s commands, functions and options?                                                                                                              |    3   | Yes
| Did the team provide troubleshooting information that describes the symptoms and step-by-step solutions for problems and error messages?                                                                       |   3    | See INSTALL.md
...
| Did the team publish the release history e.g. release data, version numbers, key features of each release etc. on your web site or in the documentation? |  3     | see releses
| Does the software describe how a user can get help with using the software?                                                                                                                                    |   3    | see google form at the end of main readme
...
| Does your software allow data to be imported and exported using open data formats? | 3 | import/export data through mongodb |                                                                                        
| Does your software allow communications using open communications protocols? | 3 | The bot uses HTTP for telegram api and flask for website |                                                                                    
| Is your software cross-platform compatible? | 3 | telegram bot works across platforms |                                                                                          
...
| Do you have tests that can be run after your software has been built or deployed to show whether the build or deployment has been successful | 3 | Tests folder, stable main branch |
...
| Do contributors keep the copyright/IP of their contributions? | 3 | Using MIT license |
